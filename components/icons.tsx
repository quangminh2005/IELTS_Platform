// Bộ icon SVG nội bộ, vẽ theo phong cách lucide (khung 24x24, nét 2, bo tròn
// đầu nét). Tự vẽ để khỏi thêm dependency icon cho vài chỗ dùng.
...
// Bài tập chung (không đoán được kỹ năng)
