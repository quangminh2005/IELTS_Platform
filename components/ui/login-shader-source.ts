// Sinh tự động bởi scripts/fetch-login-shader.mjs — đừng sửa tay.
// Nguồn: https://componentry.dev/r/hero-geometric.json (component hero-geometric của componentry.dev).
...
void main() {
    ...
    color = mix(uFadeColor, color, fadeMask);
