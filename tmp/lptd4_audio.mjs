// Tai 40 file MP3 cua "Listening Practice Through Dictation 4" len Vercel Blob,
// ghi ra tmp/lptd4_audio_urls.json (unit -> URL).
//
//   node tmp/lptd4_audio.mjs           -> chi kiem tra + bao cao (KHONG tai len)
//   node tmp/lptd4_audio.mjs --upload  -> tai len Blob
//
...
const SRC_DIR = "E:/Listening Practice Through Dictation 4/Audio + Transcipt";
const URL_MAP = "E:/web_ielts/tmp/lptd4_audio_urls.json";
...
for (let n = 1; n <= 40; n += 1) {
  ...
  const blob = await put(
    `listening/lptd4/unit-${String(n).padStart(2, "0")}.mp3`,
    fs.readFileSync(src),
